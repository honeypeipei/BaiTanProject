...
from Params.ParamsStall.paramsStall import  getNearbyStall
...
@allure.feature('getNearbyStall')
class Testgetnearbystall:

    @allure.severity('blocker')
    @allure.story('获取摊位详情')
    def test_getnearbystall_01(self):
        """
            用例描述：查看摊位详情
        """
